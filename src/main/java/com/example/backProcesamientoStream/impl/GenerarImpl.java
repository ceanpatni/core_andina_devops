...
public class GenerarImpl {
    ...
    public String generarCotizacionesCsv() {
        ...
        log.info("Página inicial: {}", properties.getDefaultPage());
        log.info("Tamaño página: {}", properties.getDefaultSize());
        log.info("AutoPaginate: {}", properties.getAutoPaginate());
        log.info("=====================================================");
    ...
    public String uploadCsvToLocal(byte[] csvData, String fileName) {
        ...
        try {
            ...
            String basePath = "C:\\Users\\Usuario1\\Documents\\LinkTIC\\CoreAndina\\Repos\\ejemplo-ms-reportes\\src\\main\\resources\\reportes";
